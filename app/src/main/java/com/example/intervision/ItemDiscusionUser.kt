...
class ItemDiscusionUser(
    ...
    private fun switchTurn(i: Int) {
        userTurnText = mutableStateOf(userNames!![i] + UiString.text1ItemDiscusionUser)
    }

    private fun defaultTurn() {
        userTurnText = mutableStateOf(UiString.textDefaultItemDiscusionUser)
    }
    ...
    fun Screen() {
        Column (
            ...
            Text(
                text = UiString.roundTextItemDiscusionLeader,
                fontWeight = FontWeight.Bold,
                fontStyle = FontStyle.Italic,
                fontSize = 20.sp
            )
            Text(
                text = UiString.text2ItemDiscusionUser,
                fontWeight = FontWeight.Bold,
                fontStyle = FontStyle.Italic,
                fontSize = 30.sp
            )
        ...
        Column (modifier = Modifier
            ...
            Row(
                ...
                Image(
                    ...
                    contentDescription = UiString.imageDesciptionItemDiscusionLeader,
        ...
        Column(
            ...
            Column (modifier = Modifier
                ...
                Row(
                    ...
                    Text(
                        text = UiString.previewtextItemDiscusionUser,
                        modifier = Modifier.padding(spacing.medium)
                    )
                }
            }
